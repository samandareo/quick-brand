...
// Generate JWT token
userSchema.methods.generateAuthToken = function (recovery = false) {
  if (recovery) {
    return jwt.sign({ id: this._id,  type: "user", walletId: this.wallet, recovery: true }, process.env.JWT_SECRET);
  }
